...
ΔF = fep(initial_eq_steps, eq_steps, prod_steps, N, m, params, λ_steps, L, LJ_pot, LJ_pot_der, λsoft_pot, dλsoft_pot_dr, dλsoft_pot_dλ,
 γ, T, δt, write_every)
...
filename = "fep_$(ρ)_$(T)_$(λ_steps).png"
savefig(filename)